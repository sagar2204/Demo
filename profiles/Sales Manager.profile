...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Student__c-Arts</layout>
        <recordType>Student__c.Arts</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Student__c-Commerce</layout>
        <recordType>Student__c.Comerce</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Student__c-Medical</layout>
        <recordType>Student__c.Medical</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Student__c-Non Medical</layout>
    ...
    <layoutAssignments>
        <layout>subject__c-Computer science</layout>
        <recordType>subject__c.Computer_science</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>subject__c-Electronics</layout>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>false</modifyAllRecords>
        <object>SpotlightMessage__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>false</allowCreate>
